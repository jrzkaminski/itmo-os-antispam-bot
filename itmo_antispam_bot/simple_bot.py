...
new_member_handler = MessageHandler(Filters.status_update.new_chat_members, track_new_members)
dispatcher.add_handler(new_member_handler)


first_message_handler = MessageHandler(Filters.text & Filters.chat_type.groups, check_first_message)
